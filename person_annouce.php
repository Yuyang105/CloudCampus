...
$con = mysql_connect("tcss545-aws-db.ce2yjmz6wbyv.us-west-2.rds.amazonaws.com","Yuyang","3350335012");
			...
			<table>
  			<tr>
    			...
    			<td align="left" bgcolor="#FFFFFF" style="padding:5px;">
    				<a href="<?php echo "organization_page.php?new=".$rows["Email"]?>"><?php echo '<span style="font-weight:bolder;">'.$rows["Name"].'</span>'?></a>
    			</td>
  			</tr>
  			...
  			<?php if ($rows["Photo"] != null) { ?>
  				<table><tr>
  					<th align="center" bgcolor="#FFFFFF"><img src="<?php echo $rows["Photo"]; ?>" width="100%" height="100%" style="border:0; margin:0; padding:0; max-width:360px; width: expression(this.width > 360 && this.width > this.height ? 360px : 'auto';); height:auto;"/></th>
  				</tr></table>
  		<?php } ?>
	...
	<div style="margin:10px;">
		...
		<tr>
    		...
    		<?php $mytime = strtotime($rows_comment["Time"]); ?>
    		<td style="word-wrap:break-word; padding:5;" align="right"><?php echo'<span style="color:#CCCCCC; font-size:small;">'.tranTime($mytime).'</span>' ?></td>
    		<td></td>
    	</tr>
    	<tr>
