		...
		<div id="wrapper">
			<div id="shadow">
				<div id="headerWrap">
					...
					<nav class="theme"><ul><li><a class="current" href="./" rel="">TCSS545</a><ul><li><a href="index.php" rel="">Log in</a></li><li><a href="registry.php" rel="">Sign up</a></li></ul></li></nav>
					</div>
				</div><!-- #headerWrap -->
				<div id="feature">
...
<form method="post" onsubmit="return check()">
	 <div>
		...
		<input class="form-input-field" type="password" name="password" style="background:#EEEEEE;" size="40"/><br /><br />
	...
	<p align="right">Don't have a Cloud Campus user account?</p>
	</div>
	<div style="text-align:right;">
	
			<button class="xavier"><a href=" registry.php"> Create an account</a></button>
	</div>
