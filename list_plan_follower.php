...
$con = mysql_connect("tcss545-aws-db.ce2yjmz6wbyv.us-west-2.rds.amazonaws.com","Yuyang","3350335012");
		...
		/*$sql="SELECT * FROM Follow WHERE Plan_Follow_Id='$plan_id' ORDER BY Follow_Id desc"; // ²éÑ¯µÄÊý¾Ý¿â±í
 		...
 		$subPage_link="list_plan_follower.php?&page="; 					//Ã¿¸ö·ÖÒ³µÄÁ´½Ó
		...
		$sql_d="SELECT * FROM Follow WHERE Plan_Follow_Id='$plan_id' ORDER BY Follow_Id desc";
		$query_d=mysql_query($sql_d,$con); 						// Ö´ÐÐSQLÖ÷¾ä
					
		while($rows=mysql_fetch_array($query_d)){
