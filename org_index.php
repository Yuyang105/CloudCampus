...
$con = mysql_connect("tcss545-aws-db.ce2yjmz6wbyv.us-west-2.rds.amazonaws.com","Yuyang","3350335012");
					...
					$sql="SELECT Avatar, Name, Introduction FROM Organizations WHERE Email='$_SESSION[user]'";
...
<?php
						//Ñ¡ÔñÊý¾Ý¿â  
		$sql="SELECT * FROM Annoucements,Organizations WHERE Annoucements.Email = '$_SESSION[user]' and Organizations.Email = '$_SESSION[user]' ORDER BY Announcement_Id desc"; // ²éÑ¯µÄÊý¾Ý¿â±í
		...
		$sql1="SELECT * FROM Annoucements,Organizations WHERE Annoucements.Email = '$_SESSION[user]' and Organizations.Email = '$_SESSION[user]' ORDER BY Announcement_Id desc limit $currentNums,$each_disNums"; //SQLÓï¾ä£¬´Ë´¦·ÖÒ³¼ÆËã
