...
<form enctype="multipart/form-data" method="post" name="upform">
  ...
  <input type="submit" name="submit" class="submit" value="Upload" class="btn btn-primary"><br>
...
$con = mysql_connect("tcss545-aws-db.ce2yjmz6wbyv.us-west-2.rds.amazonaws.com","Yuyang","3350335012");
    ...
    $_SESSION["avatar"] = $destination;
    echo "<script>alert('The new avatar looks great!');window.location='update_personal_info.php';</script>";
}
?>
			<footer>
                <hr>
